...
<template>
  <div>
    <el-form ref="loginFormRef" :model="addCandidateForm">
      <el-row :gutter="20">
        ...
        <el-form-item class="el-form-item">
          ...
          <el-col :span="4">
            <el-input v-model="addCandidateForm.age"></el-input>
          </el-col>
        </el-form-item>
        <el-form-item class="el-form-item">
          <el-col :span="4">
        ...
        <el-form-item class="el-form-item">
          ...
          <el-col :span="18">
            <el-input v-model="addCandidateForm.education"></el-input>
          </el-col>
        </el-form-item>
...
export default {
  // 注入刷新页面依赖
  inject: ["reload"],
  name: "UploadAnalysisCandidate",
  //监听candidateInfoFromFile数据变化，重新赋值
  watch: {
  ...
  props: ["candidateInfoFromFile", "updatedialogClose"],
  methods: {
    addCandidate() {
      if (
